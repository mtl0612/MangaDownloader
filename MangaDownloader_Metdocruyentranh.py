...
config_file = 'medoctruyentranh_config.ini'
...
url = "https://www.medoctruyentranh.net/truyen-tranh/chu-be-quyen-nang-2925/1"
web_url = "https://www.medoctruyentranh.net"
...
driver = webdriver.Firefox(executable_path=r'E:\HOME\Documents\geckodriver-v0.26.0-win64\geckodriver.exe')
...
while not url.endswith('#'):
    ...
    manga_name = "Chu be quyen nang"
    dir_name = normalize_file_name(manga_name)
    print("dir_name", dir_name)
    manga_elements = soup.find_all(attrs={'class': 'loadingBg'})
